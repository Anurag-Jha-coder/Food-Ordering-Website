...
<body>
    <div class="container">
        ...
        <form action= "" method = "post" class="form " id="createAccount">
            <h1 class="from__title">Create Account</h1>
            ...
            <div class="form__input-group">
                <input type="password" class="form__input "name = "confirm_password"  placeholder=" Confirm Passoward">
                <div class="form__input-error-message"></div>
            </div>
            ...
            <p class="form__text">
                <a herf="./" id="linkLogin" class="form__link">Already have an account? Sign in</a>
            </p>
        </form>
    </div>
</body>
